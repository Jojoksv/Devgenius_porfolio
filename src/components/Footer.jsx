...
function Footer(){
    return(
        <footer>
            <div className="footerFooter projetdevgenius joseph Kossouvi jojoksv devgenius">
                <div className='footerTitle projetdevgenius joseph Kossouvi jojoksv devgenius'>
                    <div className="footerdoted"></div>
                    <h1>DEV<span>GENIUS</span></h1>
                </div>
                <div className='AboutMe projetdevgenius joseph Kossouvi jojoksv devgenius'>
